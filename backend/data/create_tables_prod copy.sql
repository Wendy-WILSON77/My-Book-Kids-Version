...
DROP TABLE IF EXISTS "user_like_book" CASCADE;
DROP TABLE IF EXISTS "user_read_book" CASCADE;
DROP TABLE IF EXISTS "list_has_book" CASCADE;
DROP TABLE IF EXISTS "book_has_category" CASCADE;
